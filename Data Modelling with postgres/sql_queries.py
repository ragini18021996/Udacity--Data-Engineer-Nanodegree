...
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplays(
	songplay_id SERIAL CONSTRAINT songplay_id_pk PRIMARY KEY,
...
user_table_create = ("""CREATE TABLE IF NOT EXISTS  users(
	user_id  INT CONSTRAINT users_id_pk PRIMARY KEY,
	first_name  VARCHAR ,
	last_name  VARCHAR ,
	gender  CHAR(1),
	level VARCHAR NOT NULL
...
song_table_create = ("""CREATE TABLE  IF NOT EXISTS songs(
	song_id VARCHAR CONSTRAINT songs_id_pk PRIMARY KEY,
	title  VARCHAR,
	artist_id  VARCHAR REFERENCES artists (artist_id),
	year INT,
	duration FLOAT
...
time_table_create = ("""CREATE TABLE IF NOT EXISTS  time(
	start_time TIME CONSTRAINT time_id_pk PRIMARY KEY,
...
# user level might change an need to be updated.
